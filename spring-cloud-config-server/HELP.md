...
* The original package name 'com.microservices.spring-cloud-config-server' is invalid and this project uses 'com.microservices.springcloudconfigserver' instead.
