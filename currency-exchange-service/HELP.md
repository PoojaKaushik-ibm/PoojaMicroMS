...
* The original package name 'com.microservices.currency-exchange-service' is invalid and this project uses 'com.microservices.currencyexchangeservice' instead.
